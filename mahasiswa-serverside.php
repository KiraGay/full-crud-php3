...
if ($_GET['action'] == "table_data") {
    ...
    if (!empty($query)) {
        ...
        while ($value = $query->fetch_array()) {
            ...
            $nestedData['aksi'] = '<div class="text-center" width="20%">
                ...
                <a href="hapus-mahasiswa.php?id_mahasiswa=' . $value['id_mahasiswa'] . '" class="btn btn-danger btn-sm" onclick="return confirm(\'Yakin Data Mahasiswa Akun Dihapus?\');"><i class="fas fa-trash-alt"></i> Hapus</a>
            </div>';
    ...
    // Bersihkan output buffering dan kirim JSON
    ob_end_clean();
